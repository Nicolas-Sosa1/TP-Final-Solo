<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginMedico.aspx.cs" Inherits="Vistas.LoginMedico" %>
...
&nbsp;<asp:RequiredFieldValidator ID="rfvContrasena" runat="server" ControlToValidate="txtContrasena" ErrorMessage="Debe ingresar una contraseña" ValidationGroup="1">*</asp:RequiredFieldValidator>
            ...
            <asp:TextBox ID="txtContrasenaRepetida" runat="server" TextMode="Password" ValidationGroup="1"></asp:TextBox>
